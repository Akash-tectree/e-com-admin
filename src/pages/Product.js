          ...
          >
            ...
            <div className="w-full flex justify-end">
              <Button
                ...
                className="w-full md:w-56 lg:w-56 xl:w-56 rounded-md h-12"
              >
                <span className="mr-3">
                  <FiPlus />
                </span>
        ...
        <CardBody>
          <div className="grid gap-4 md:grid-cols-3 xl:grid-cols-3">
            {exportOpen && (
              <div className="col-span-2">
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  <Button onClick={() => setExportOpen(false)} layout="outline">
                    Cancel
                  </Button>
                </div>
              </div>
            ...
            <div className="flex  gap-2 items-center h-12">
              <Button onClick={() => setExportOpen(true)} layout="outline">
                Import
              </Button>
              <div className="w-full">
                <CSVDownloader data={productData} filename={"products"}>
                  <Button onClick={() => setExportOpen(false)} className="">
                    Export
                  </Button>
                </CSVDownloader>
              </div>
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                <TableCell>Measure Conversion</TableCell>
                <TableCell>Quantity Measure</TableCell>
                <TableCell>Quantity</TableCell>
                <TableCell>Price</TableCell>
                <TableCell>Active</TableCell>
                <TableCell className="text-center">Popular Product</TableCell>
