...
const DrawerButton = ({id, title}) => {
  ...
  return (
    <>
      <div className="fixed bottom-0 w-[300px] right-0 py-4 lg:py-8 px-6 grid gap-4 lg:gap-6 xl:gap-6 md:flex xl:flex  border-t border-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
